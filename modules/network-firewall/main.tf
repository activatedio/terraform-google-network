...
resource "google_compute_firewall" "private_allow_all_network_inbound" {
  ...
  ], [ for s in data.google_compute_subnetwork.private_subnetworks : s.ip_cidr_range ]
  , [ for s in data.google_compute_subnetwork.private_subnetworks : s.secondary_ip_range[0].ip_cidr_range ]
